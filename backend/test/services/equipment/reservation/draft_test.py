...
def test_draft_reservation_some_taken_equipment(reservation_svc: ReservationService):
...
def test_draft_reservation_all_closed_equipment(reservation_svc: ReservationService):
